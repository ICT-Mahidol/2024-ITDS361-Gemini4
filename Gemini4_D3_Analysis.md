...
| **Subflows**             | **S-1:** 1. ระบบตรวจสอบ Syntax ความเข้ากันได้, และเงื่อนไขที่เกี่ยวข้อง<br> 2. หากพบข้อผิดพลาด ระบบจะปฏิเสธไฟล์ค่ากำหนดนั้น <br> **S-2:** 1. ระบบตรวจสอบ Syntax ความเข้ากันได้ และเงื่อนไขที่เกี่ยวข้อง 2. หากการตรวจสอบผ่าน ระบบจะติดตั้งค่ากำหนดใหม่ และโหลดค่ากำหนดใหม่ |
...
| **Subflows**             | **S-1: ค้นหาข้อมูลจากวันที่** <br> - ระบุข้อมูลวันที่ <br> - ระบบแสดงข้อมูล <br> **S-2: ค้นหาข้อมูลจากวัตถุที่สังเกต** <br> - ระบุข้อมูลวัตถุที่สังเกต <br> - ระบบแสดงข้อมูล <br> **S-3: ค้นหาข้อมูลจากกล้องโทรทรรศน์ที่ใช้** <br> - ระบุข้อมูลกล้องโทรทรรศน์ที่ใช้ <br> - ระบบแสดงข้อมูล |
