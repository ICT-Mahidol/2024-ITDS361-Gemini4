...
| **Subflows**             | **S-1:** <br>1. ระบบตรวจสอบ Syntax ความเข้ากันได้, และเงื่อนไขที่เกี่ยวข้อง<br> 2. หากพบข้อผิดพลาด ระบบจะปฏิเสธไฟล์ค่ากำหนดนั้น <br> **S-2:** <br>1. ระบบตรวจสอบ Syntax ความเข้ากันได้ และเงื่อนไขที่เกี่ยวข้อง 2. หากการตรวจสอบผ่าน ระบบจะติดตั้งค่ากำหนดใหม่ และโหลดค่ากำหนดใหม่ |
